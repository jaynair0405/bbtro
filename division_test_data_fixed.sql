-- Division Portal Test Data (matching actual table structure)
...
VALUES
-- CSMT Staff (5 staff)
('HRMS001', 'CMS12345', 'CMS12345', 'Rajesh Kumar Sharma', 'CSMT', 1, 'A', 'permanent', '1985-03-15', '2010-06-01'),
('HRMS002', 'CMS12346', 'CMS12346', 'Priya Deshmukh', 'CSMT', 2, 'B', 'permanent', '1990-07-22', '2015-04-10'),
('HRMS003', 'CMS12347', 'CMS12347', 'Amit Patil', 'CSMT', 1, 'A', 'permanent', '1988-11-30', '2012-08-15'),
('HRMS004', 'CMS12348', 'CMS12348', 'Sneha Joshi', 'CSMT', 3, 'C', 'permanent', '1992-05-18', '2018-01-20'),
('HRMS005', 'CMS12349', 'CMS12349', 'Vikram Singh', 'CSMT', 1, 'A', 'permanent', '1987-09-10', '2011-03-05'),

-- PNVL Staff (3 staff)
('HRMS006', 'CMS12350', 'CMS12350', 'Anjali Mehta', 'PNVL', 2, 'B', 'permanent', '1991-02-28', '2016-07-12'),
('HRMS007', 'CMS12351', 'CMS12351', 'Suresh Yadav', 'PNVL', 1, 'A', 'permanent', '1986-08-14', '2010-11-22'),
('HRMS008', 'CMS12352', 'CMS12352', 'Kavita Nair', 'PNVL', 3, 'C', 'permanent', '1993-12-05', '2019-05-30'),

-- KYN Staff (2 staff)
('HRMS009', 'CMS12353', 'CMS12353', 'Ravi Kulkarni', 'KYN', 1, 'A', 'permanent', '1989-04-17', '2013-02-14'),
('HRMS010', 'CMS12354', 'CMS12354', 'Deepa Sawant', 'KYN', 2, 'B', 'permanent', '1990-10-08', '2015-09-01'),
...
VALUES
('HRMS003', 'CSMT', 'PNVL', '2025-09-20', 'Pending', 'Family reasons'),
('HRMS007', 'PNVL', 'KYN', '2025-09-25', 'Pending', 'Proximity to residence')
